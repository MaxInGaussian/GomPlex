...
mse = Metric('mse').eval(target, mu_pred, std_pred)
print('\t mse =', mse)

print('test of nmse metric')
nmse = Metric('nmse').eval(target, mu_pred, std_pred)
print('\t nmse =', nmse)

print('test of nlpd metric')
nlpd = Metric('nlpd').eval(target, mu_pred, std_pred)
print('\t nlpd =', nlpd)
